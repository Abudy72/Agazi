...
export const matchData = mysqlTable("match_data", {
    ...
    jungle_camp_xp: int("jungle_camp_xp").notNull().default(0),

    jungle_camp_gold: int("jungle_camp_gold").notNull().default(0),
    jungle_camp_lowestLevel_xp: int("jungle_camp_lowestLevel_xp").notNull().default(0),
    minion_assist_xp: int("minion_assist_xp").notNull().default(0),
    minion_assist_gold: int("minion_assist_gold").notNull().default(0),
    minion_kill_xp: int("minion_kill_xp").notNull().default(0),
    minion_kill_gold: int("minion_kill_gold").notNull().default(0),
    minion_lowestLevel_xp: int("minion_lowestLevel_xp").notNull().default(0),
    gold_blessing: int("gold_blessing").notNull().default(0),
    player_kill_xp: int("player_kill_xp").notNull().default(0),
    player_kill_gold: int("player_kill_gold").notNull().default(0),
    god_name: varchar("god_name", { length: 255 }),
    starter_item: varchar("starter_item", { length: 255 }),
    aspect: varchar("aspect", { length: 255 }),
