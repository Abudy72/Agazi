...
export const PageNotFound = () => {
  return (
    <div className="relative flex flex-col items-center text-lightYellow w-full gap-8 px-8 md:px-18 xl:px-40 md:gap-16">
        <h1 className="text-9xl md:text-[300px] w-full select-none  text-center font-black  text-lightBlue">
            404</h1>
