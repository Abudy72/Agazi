...
const UpcomingMatchCard: React.FC<UpcomingMatchProps> = ({
  ...
  <div className="bg-secondaryBG text-lightBlue p-4 rounded-lg w-64 shadow-lg m-2 hover:-translate-y-1 hover:scale-110 duration-300">
    ...
    <div className="text-center space-y-2 mb-2 border-t pt-2 border-white">
      <span className="text-xl text-lightYellow">
        {" "}
        {teamA} <br />{" "}
      </span>
